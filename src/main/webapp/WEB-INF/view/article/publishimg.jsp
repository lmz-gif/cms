 ...
 */
function addimg(){
	$("#imgs").append('<div id="imgs" class="container"><div class="form-group row "> <label for="title">文章图片</label> <input type="file" class="form-control"  name="imgs"> <label for="title">图片描述</label> <input type="text" class="form-control"  name="imgsdesc"></div></div>')
}
